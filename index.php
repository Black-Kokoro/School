<?php include_once 'includes/CustomerSideHeader.php'; ?>
					...
					<div class="col-md-10 offset-md-1">
						...
						<form class="course-search-form">
							...
							<input type="text" class="last-m" placeholder="Category">
                                                        <button class="site-btn" id="btc">Search Couse</button>
						</form>
					</div>
				</div>
			</div>
	...
	<section class="course-section spad">
		<div class="container">
			<div class="section-title mb-0">
                            <h2 id="indexcw">Featured Courses</h2>
		...
		<div class="course-warp" >
			<ul class="course-filter controls" >
				...
				<li class="control" id="indexcw" data-filter=".finance">Finance</li>
				<li class="control" id="indexcw" data-filter=".design">Design</li>
				<li class="control" id="indexcw" data-filter=".web">Web Development</li>
				<li class="control" id="indexcw" data-filter=".photo">Photography</li>
			</ul>                                       
	...
	<!-- signup section -->
	<section class="signup-section spad" id="btco">
